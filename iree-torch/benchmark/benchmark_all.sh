...
MODEL_RESNET50_FP16_PT="aff75509-4420-40a8-844e-dbfc48494fe6-MODEL_RESNET50-fp16-PT-3x224x224xf16"
MODEL_BERT_LARGE_FP32_PT="47cb0d3a-5eb7-41c7-9d7c-97aae7023ecf-MODEL_BERT_LARGE-fp32-PT-384xi32"
MODEL_BERT_LARGE_FP16_PT="47cb0d3a-5eb7-41c7-9d7c-97aae7023ecf-MODEL_BERT_LARGE-fp16-PT-384xi32"
...
declare -a gpu_benchmark_ids=(
  ...
  "${MODEL_RESNET50_FP16_PT}-batch1"
  "${MODEL_RESNET50_FP16_PT}-batch8"
  "${MODEL_RESNET50_FP16_PT}-batch64"
  "${MODEL_RESNET50_FP16_PT}-batch128"
  "${MODEL_RESNET50_FP16_PT}-batch256"
  "${MODEL_RESNET50_FP16_PT}-batch2048"
  ...
  "${MODEL_BERT_LARGE_FP16_PT}-batch1"
  "${MODEL_BERT_LARGE_FP16_PT}-batch16"
  "${MODEL_BERT_LARGE_FP16_PT}-batch24"
  "${MODEL_BERT_LARGE_FP16_PT}-batch32"
  "${MODEL_BERT_LARGE_FP16_PT}-batch48"
  "${MODEL_BERT_LARGE_FP16_PT}-batch64"
  "${MODEL_BERT_LARGE_FP16_PT}-batch512"
  "${MODEL_BERT_LARGE_FP16_PT}-batch1024"
  "${MODEL_BERT_LARGE_FP16_PT}-batch1280"
)
