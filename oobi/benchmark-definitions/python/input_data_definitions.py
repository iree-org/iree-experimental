...
IMAGENET_APPLES_224X224X3XF32_BATCH1 = data_types.ModelData(
    ...
    source_info="Original image: https://storage.googleapis.com/iree-model-artifacts/ILSVRC2012_val_00000023.JPEG",
...
BERT_LARGE_SEQLEN384_I32_BATCH1 = data_types.ModelData(
    ...
    tensor_names=["serving_default_input_ids", "serving_default_attention_mask"],
...
T5_LARGE_SEQLEN512_I32_BATCH1 = data_types.ModelData(
    ...
    source_info="Original text: 'Studies have been shown that owning a dog is good for you'",
    tensor_names=["serving_default_input_ids", "serving_default_decoder_input_ids"],
