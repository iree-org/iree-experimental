...
//   sed "s/\${M}/192/g" | sed "s/\${K}/1234/g" | sed "s/\${N}/512/g" | \
...
//     --input="192x1234xf32=1" \
//     --input="1234x512xf32=2" \
//     --input="192x512xf32=3"
// ```
...
^bb1(%variant_op: !pdl.operation):
  ...
  // TODO: vector.transfer hoisting does not yet know how to account for masks.
  // %func_3 = transform.structured.hoist_redundant_tensor_subsets %func
  //   : (!pdl.operation) -> !pdl.operation
