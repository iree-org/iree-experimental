...
//   iree-opt --pass-pipeline="builtin.module(func.func(iree-transform-dialect-interpreter{transform-file-name=transform_dialect/graph/cuda/bugs/2.mlir}))" | \
...
^bb1(%module_op: !pdl.operation):
  ...
  // Disabling the following line passes the test.
